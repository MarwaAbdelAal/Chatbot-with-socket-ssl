...
context.load_verify_locations("./security/snakeoil.pem")

# Load client certificate
context.load_cert_chain(certfile="./security/snakeoil.pem", keyfile="./security/snakeoil.key")
...
# Prepare username, encode to bytes and send
...
while True:
    ...
    if message:
        ...
        # Encode message to bytes, prepare and convert to bytes, like for username above, then send
